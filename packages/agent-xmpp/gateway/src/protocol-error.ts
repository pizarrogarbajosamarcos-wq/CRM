...
export class ProtocolError extends Error {
	constructor(
		...
		message: string,
		readonly type: "cancel" | "modify" | "auth" | "wait" = stanzaErrorType(
			condition,
		),
	) {
		super(message);
