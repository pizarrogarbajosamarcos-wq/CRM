...
export function isAskQuestionContent(
	content: unknown,
): content is AskQuestionPayload {
...
export function buildAskQuestionFormStanza(
...
export function parseAskQuestionSubmit(
	stanza: Element,
): AskQuestionSubmit | null {
